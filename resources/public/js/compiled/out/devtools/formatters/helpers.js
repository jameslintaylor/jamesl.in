...
var G__55713 = devtools.prefs.pref.call(null,v);
v = G__55713;
continue;
} else {
return v;
...
var and__41981__auto__ = cljs.core.not.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"disable-cljs-fn-formatting","disable-cljs-fn-formatting",1903786837)));
if(and__41981__auto__){
var and__41981__auto____$1 = !(cljs.core.var_QMARK_.call(null,value));
...
var or__41993__auto__ = (function (){try{if(!((value == null))){
...
}catch (e55726){var e__54659__auto__ = e55726;
return false;
}})();
if(cljs.core.truth_(or__41993__auto__)){
return or__41993__auto__;
} else {
var or__41993__auto____$1 = (function (){try{if(!((value == null))){
...
}catch (e55730){var e__54659__auto__ = e55730;
return false;
}})();
...
}catch (e55732){var e__54659__auto__ = e55732;
return false;
}}
}
});
devtools.formatters.helpers.cljs_type_QMARK_ = (function devtools$formatters$helpers$cljs_type_QMARK_(f){
var and__41981__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__41981__auto__)){
var and__41981__auto____$1 = cljs.core.not.call(null,devtools.formatters.helpers.is_prototype_QMARK_.call(null,f));
if(and__41981__auto____$1){
...
var and__41981__auto__ = goog.isObject(value);
if(cljs.core.truth_(and__41981__auto__)){
...
var or__41993__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(or__41993__auto__)){
return or__41993__auto__;
} else {
...
var and__41981__auto__ = (function (){var or__41993__auto__ = devtools.formatters.helpers.cljs_land_value_QMARK_.call(null,value);
if(cljs.core.truth_(or__41993__auto__)){
return or__41993__auto__;
} else {
...
var vec__55737 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__55737,(0),null);
var name = cljs.core.nth.call(null,vec__55737,(1),null);
...
var and__41981__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(and__41981__auto__)){
...
var or__41993__auto__ = typeof value === 'string';
if(or__41993__auto__){
return or__41993__auto__;
} else {
var or__41993__auto____$1 = typeof value === 'number';
...
return cljs.core.some.call(null,(function (p1__55740_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__55740_SHARP_);
}),template);
});
...
//# sourceMappingURL=helpers.js.map?rel=1504122785922