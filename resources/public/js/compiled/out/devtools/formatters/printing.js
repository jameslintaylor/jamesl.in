...
var len__43068__auto___55756 = arguments.length;
var i__43069__auto___55757 = (0);
while(true){
if((i__43069__auto___55757 < len__43068__auto___55756)){
args__43075__auto__.push((arguments[i__43069__auto___55757]));

var G__55758 = (i__43069__auto___55757 + (1));
i__43069__auto___55757 = G__55758;
continue;
} else {
}
break;
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__43076__auto__);
});
...
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq55753){
var G__55754 = cljs.core.first.call(null,seq55753);
var seq55753__$1 = cljs.core.next.call(null,seq55753);
var G__55755 = cljs.core.first.call(null,seq55753__$1);
var seq55753__$2 = cljs.core.next.call(null,seq55753__$1);
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic(G__55754,G__55755,seq55753__$2);
});
...
if(cljs.core.truth_((function (){var or__41993__auto__ = devtools.formatters.helpers.directly_printable_QMARK_.call(null,value);
...
devtools.formatters.printing.TemplateWriter.cljs$lang$ctorPrWriter = (function (this__42599__auto__,writer__42600__auto__,opt__42601__auto__){
return cljs.core._write.call(null,writer__42600__auto__,"devtools.formatters.printing/TemplateWriter");
});
...
if(cljs.core.truth_((function (){var and__41981__auto__ = cljs.core.not.call(null,devtools.formatters.printing.already_reference_QMARK_.call(null,group));
if(and__41981__auto__){
var or__41993__auto__ = devtools.formatters.helpers.expandable_QMARK_.call(null,obj);
if(cljs.core.truth_(or__41993__auto__)){
return or__41993__auto__;
} else {
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__55759_SHARP_){
return cljs.core.some_QMARK_.call(null,cljs.core.meta.call(null,p1__55759_SHARP_));
})))){
...
var map__55768 = opts;
var map__55768__$1 = ((((!((map__55768 == null)))?((((map__55768.cljs$lang$protocol_mask$partition0$ & (64))) || (map__55768.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__55768):map__55768);
var markup_db = cljs.core.get.call(null,map__55768__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
if(cljs.core.truth_((function (){var or__41993__auto__ = (function (){try{if(!((obj == null))){
...
}catch (e55772){var e__54659__auto__ = e55772;
return false;
}})();
if(cljs.core.truth_(or__41993__auto__)){
return or__41993__auto__;
...
}catch (e55774){var e__54659__auto__ = e55774;
return false;
}}
})())){
...
var _STAR_current_state_STAR_55779 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__55780 = opts;
var map__55780__$1 = ((((!((map__55780 == null)))?((((map__55780.cljs$lang$protocol_mask$partition0$ & (64))) || (map__55780.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__55780):map__55780);
var markup_db = cljs.core.get.call(null,map__55780__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_55779;
}});
...
;
var temp__4655__auto___55785 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__4655__auto___55785)){
var managed_print_level_55786 = temp__4655__auto___55785;
var _STAR_print_level_STAR_55784_55787 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_55786;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_55784_55787,managed_print_level_55786,temp__4655__auto___55785,writer,opts,job_fn){
return (function (p1__55782_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__55782_SHARP_,null);
});})(_STAR_print_level_STAR_55784_55787,managed_print_level_55786,temp__4655__auto___55785,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_55784_55787;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1504122786048