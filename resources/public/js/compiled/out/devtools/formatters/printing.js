...
var len__43068__auto___55751 = arguments.length;
var i__43069__auto___55752 = (0);
while(true){
if((i__43069__auto___55752 < len__43068__auto___55751)){
args__43075__auto__.push((arguments[i__43069__auto___55752]));

var G__55753 = (i__43069__auto___55752 + (1));
i__43069__auto___55752 = G__55753;
continue;
} else {
}
break;
...
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq55748){
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic(G__55749,G__55750,seq55748__$2);
});
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__55754_SHARP_){
return cljs.core.some_QMARK_.call(null,cljs.core.meta.call(null,p1__55754_SHARP_));
})))){
...
var map__55763 = opts;
var map__55763__$1 = ((((!((map__55763 == null)))?((((map__55763.cljs$lang$protocol_mask$partition0$ & (64))) || (map__55763.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__55763):map__55763);
var markup_db = cljs.core.get.call(null,map__55763__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e55767){var e__54654__auto__ = e55767;
return false;
}})();
if(cljs.core.truth_(or__41993__auto__)){
return or__41993__auto__;
...
}catch (e55769){var e__54654__auto__ = e55769;
return false;
}}
})())){
...
var _STAR_current_state_STAR_55774 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__55775 = opts;
var map__55775__$1 = ((((!((map__55775 == null)))?((((map__55775.cljs$lang$protocol_mask$partition0$ & (64))) || (map__55775.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__55775):map__55775);
var markup_db = cljs.core.get.call(null,map__55775__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_55774;
}});
...
;
var temp__4655__auto___55780 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__4655__auto___55780)){
var managed_print_level_55781 = temp__4655__auto___55780;
var _STAR_print_level_STAR_55779_55782 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_55781;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_55779_55782,managed_print_level_55781,temp__4655__auto___55780,writer,opts,job_fn){
return (function (p1__55777_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__55777_SHARP_,null);
});})(_STAR_print_level_STAR_55779_55782,managed_print_level_55781,temp__4655__auto___55780,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_55779_55782;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1504724092641