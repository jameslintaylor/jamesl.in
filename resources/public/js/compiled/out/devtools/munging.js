...
var temp__4657__auto____$1 = goog.object.get(o__54642__auto__,"core");
if(cljs.core.truth_(temp__4657__auto____$1)){
var o__54641__auto__ = temp__4657__auto____$1;
return goog.object.get(o__54641__auto__,"js_reserved_QMARK_");
} else {
return null;
}
} else {
...
try{var o__54629__auto__ = f;
return goog.object.get(o__54629__auto__,"toString").call(o__54629__auto__);
}catch (e55562){var _ = e55562;
return "";
}});
...
try{var o__54629__auto___55565 = t;
goog.object.get(o__54629__auto___55565,"cljs$lang$ctorPrWriter").call(o__54629__auto___55565,t,writer);
}catch (e55564){var __55566 = e55564;
}
...
var char_code = (function (){var o__54629__auto__ = (new String(char$));
return goog.object.get(o__54629__auto__,"charCodeAt").call(o__54629__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__54629__auto__ = String;
return goog.object.get(o__54629__auto__,"fromCharCode").call(o__54629__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__55568 = num_code;
switch (G__55568) {
case (1):
return (185);
...
var o__54629__auto__ = String;
return goog.object.get(o__54629__auto__,"fromCharCode").call(o__54629__auto__,superscript_code);
});
/**
...
}catch (e55574){var e__54654__auto__ = e55574;
return false;
}})())){
...
var vec__55575 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__55575,(0),null);
...
if(cljs.core.truth_(temp__4657__auto__)){
var o__54642__auto__ = temp__4657__auto__;
var temp__4657__auto____$1 = goog.object.get(o__54642__auto__,"dependencies_");
if(cljs.core.truth_(temp__4657__auto____$1)){
var o__54641__auto__ = temp__4657__auto____$1;
return goog.object.get(o__54641__auto__,"nameToPath");
} else {
return null;
}
} else {
...
var len__43068__auto___55584 = arguments.length;
var i__43069__auto___55585 = (0);
while(true){
if((i__43069__auto___55585 < len__43068__auto___55584)){
args__43075__auto__.push((arguments[i__43069__auto___55585]));

var G__55586 = (i__43069__auto___55585 + (1));
i__43069__auto___55585 = G__55586;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__55580){
var vec__55581 = p__55580;
var ns_detector = cljs.core.nth.call(null,vec__55581,(0),null);
...
var G__55587 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__55588 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__55587;
remaining_tokens = G__55588;
continue;
}
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq55578){
var G__55579 = cljs.core.first.call(null,seq55578);
var seq55578__$1 = cljs.core.next.call(null,seq55578);
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(G__55579,seq55578__$1);
});
...
var vec__55596 = cljs.core.split_with.call(null,(function (p1__55592_SHARP_){
return cljs.core.not_EQ_.call(null,p1__55592_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__55596,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__55596,(1),null);
...
var vec__55602 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__55602,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__55602,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__55605 = cljs.core.rest.call(null,remaining_tokens);
var G__55606 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__55605;
name_tokens = G__55606;
continue;
} else {
...
var args55607 = [];
var len__43068__auto___55619 = arguments.length;
var i__43069__auto___55620 = (0);
while(true){
if((i__43069__auto___55620 < len__43068__auto___55619)){
args55607.push((arguments[i__43069__auto___55620]));

var G__55621 = (i__43069__auto___55620 + (1));
i__43069__auto___55620 = G__55621;
continue;
} else {
}
break;
...
var vec__55610 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__55610,(0),null);
var arity = cljs.core.nth.call(null,vec__55610,(1),null);
var vec__55613 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__55613,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__55613,(1),null);
var vec__55616 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__55616,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__55616,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__55616,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__55616,(3),null);
...
var args55623 = [];
var len__43068__auto___55629 = arguments.length;
var i__43069__auto___55630 = (0);
while(true){
if((i__43069__auto___55630 < len__43068__auto___55629)){
args55623.push((arguments[i__43069__auto___55630]));

var G__55631 = (i__43069__auto___55630 + (1));
i__43069__auto___55630 = G__55631;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args55623.length)].join('')));
...
var vec__55626 = result;
var munged_ns = cljs.core.nth.call(null,vec__55626,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__55626,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__55626,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__55626,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__55626,(4),null);
var arity = cljs.core.nth.call(null,vec__55626,(5),null);
...
if(cljs.core.truth_(temp__4655__auto__)){
var vec__55639 = temp__4655__auto__;
var munged_name = cljs.core.nth.call(null,vec__55639,(0),null);
var args = cljs.core.nth.call(null,vec__55639,(1),null);
var vec__55642 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__55642,(0),null);
var name = cljs.core.nth.call(null,vec__55642,(1),null);
...
var G__55645 = (arity + (1));
var G__55646 = (function (){var temp__4655__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__4655__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__55647){
var vec__55651 = p__55647;
var arity = cljs.core.nth.call(null,vec__55651,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__55651,(1),null);
...
return cljs.core.get.call(null,arities,p1__55654_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return (function (p1__55655_SHARP_){
return cljs.core.drop.call(null,(2),p1__55655_SHARP_);
...
var args__43075__auto__ = [];
var len__43068__auto___55662 = arguments.length;
var i__43069__auto___55663 = (0);
while(true){
if((i__43069__auto___55663 < len__43068__auto___55662)){
args__43075__auto__.push((arguments[i__43069__auto___55663]));

var G__55664 = (i__43069__auto___55663 + (1));
i__43069__auto___55663 = G__55664;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__55658){
var vec__55659 = p__55658;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__55659,(0),null);
...
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq55656){
var G__55657 = cljs.core.first.call(null,seq55656);
var seq55656__$1 = cljs.core.next.call(null,seq55656);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic(G__55657,seq55656__$1);
});
...
var G__55666 = (((arg instanceof cljs.core.Keyword))?arg.fqn:null);
switch (G__55666) {
...
var map__55673 = options;
var map__55673__$1 = ((((!((map__55673 == null)))?((((map__55673.cljs$lang$protocol_mask$partition0$ & (64))) || (map__55673.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__55673):map__55673);
var include_ns_QMARK_ = cljs.core.get.call(null,map__55673__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__55673__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__55673__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__55673__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__55674 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__55674,(0),null);
var fn_name = cljs.core.nth.call(null,vec__55674,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__55674,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__55674,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__55674,(4),null);
var arity = cljs.core.nth.call(null,vec__55674,(5),null);
...
var o__54629__auto__ = f;
return goog.object.get(o__54629__auto__,"getBasis").call(o__54629__auto__);
});
/**
...
}catch (e55679){var e__54654__auto__ = e55679;
...
var G__55680 = goog.object.get(obj,cljs.core.first.call(null,path));
var G__55681 = cljs.core.rest.call(null,path);
obj = G__55680;
path = G__55681;
continue;
} else {
...
return (function (accum,p__55686){
var vec__55687 = p__55686;
var bit = cljs.core.nth.call(null,vec__55687,(0),null);
var protocol = cljs.core.nth.call(null,vec__55687,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__55690){
var vec__55694 = p__55690;
var ns = cljs.core.nth.call(null,vec__55694,(0),null);
var name = cljs.core.nth.call(null,vec__55694,(1),null);
var selector = cljs.core.nth.call(null,vec__55694,(2),null);
...
return (function (p__55702){
var vec__55703 = p__55702;
var munged_name = cljs.core.nth.call(null,vec__55703,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__55703,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__55703,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__55697_SHARP_){
return goog.object.get(obj,cljs.core.first.call(null,p1__55697_SHARP_));
});})(name,sorted_matches,vec__55703,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1504724092407