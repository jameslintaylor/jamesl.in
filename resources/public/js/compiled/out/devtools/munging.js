...
var temp__4657__auto____$1 = goog.object.get(o__54647__auto__,"core");
if(cljs.core.truth_(temp__4657__auto____$1)){
var o__54646__auto__ = temp__4657__auto____$1;
return goog.object.get(o__54646__auto__,"js_reserved_QMARK_");
} else {
return null;
}
} else {
...
try{var o__54634__auto__ = f;
return goog.object.get(o__54634__auto__,"toString").call(o__54634__auto__);
}catch (e55567){var _ = e55567;
return "";
}});
...
try{var o__54634__auto___55570 = t;
goog.object.get(o__54634__auto___55570,"cljs$lang$ctorPrWriter").call(o__54634__auto___55570,t,writer);
}catch (e55569){var __55571 = e55569;
}
...
var char_code = (function (){var o__54634__auto__ = (new String(char$));
return goog.object.get(o__54634__auto__,"charCodeAt").call(o__54634__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__54634__auto__ = String;
return goog.object.get(o__54634__auto__,"fromCharCode").call(o__54634__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__55573 = num_code;
switch (G__55573) {
case (1):
return (185);
...
var o__54634__auto__ = String;
return goog.object.get(o__54634__auto__,"fromCharCode").call(o__54634__auto__,superscript_code);
});
/**
...
}catch (e55579){var e__54659__auto__ = e55579;
return false;
}})())){
...
var vec__55580 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__55580,(0),null);
...
var or__41993__auto__ = (function (){var temp__4655__auto__ = cljs.core.re_matches.call(null,/(.*)\$/,s);
if(cljs.core.truth_(temp__4655__auto__)){
...
if(cljs.core.truth_(temp__4657__auto__)){
var o__54647__auto__ = temp__4657__auto__;
var temp__4657__auto____$1 = goog.object.get(o__54647__auto__,"dependencies_");
if(cljs.core.truth_(temp__4657__auto____$1)){
var o__54646__auto__ = temp__4657__auto____$1;
return goog.object.get(o__54646__auto__,"nameToPath");
} else {
return null;
}
} else {
...
var len__43068__auto___55589 = arguments.length;
var i__43069__auto___55590 = (0);
while(true){
if((i__43069__auto___55590 < len__43068__auto___55589)){
args__43075__auto__.push((arguments[i__43069__auto___55590]));

var G__55591 = (i__43069__auto___55590 + (1));
i__43069__auto___55590 = G__55591;
continue;
} else {
}
break;
...
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__43076__auto__);
});

devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__55585){
var vec__55586 = p__55585;
var ns_detector = cljs.core.nth.call(null,vec__55586,(0),null);
var effective_detector = (function (){var or__41993__auto__ = ns_detector;
if(cljs.core.truth_(or__41993__auto__)){
return or__41993__auto__;
} else {
...
var G__55592 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__55593 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__55592;
remaining_tokens = G__55593;
continue;
}
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq55583){
var G__55584 = cljs.core.first.call(null,seq55583);
var seq55583__$1 = cljs.core.next.call(null,seq55583);
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(G__55584,seq55583__$1);
});
...
var vec__55601 = cljs.core.split_with.call(null,(function (p1__55597_SHARP_){
return cljs.core.not_EQ_.call(null,p1__55597_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__55601,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__55601,(1),null);
...
var vec__55607 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__55607,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__55607,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__55610 = cljs.core.rest.call(null,remaining_tokens);
var G__55611 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__55610;
name_tokens = G__55611;
continue;
} else {
...
var args55612 = [];
var len__43068__auto___55624 = arguments.length;
var i__43069__auto___55625 = (0);
while(true){
if((i__43069__auto___55625 < len__43068__auto___55624)){
args55612.push((arguments[i__43069__auto___55625]));

var G__55626 = (i__43069__auto___55625 + (1));
i__43069__auto___55625 = G__55626;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args55612.length)].join('')));
...
var vec__55615 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__55615,(0),null);
var arity = cljs.core.nth.call(null,vec__55615,(1),null);
var vec__55618 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__55618,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__55618,(1),null);
var vec__55621 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__55621,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__55621,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__55621,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__55621,(3),null);
...
var args55628 = [];
var len__43068__auto___55634 = arguments.length;
var i__43069__auto___55635 = (0);
while(true){
if((i__43069__auto___55635 < len__43068__auto___55634)){
args55628.push((arguments[i__43069__auto___55635]));

var G__55636 = (i__43069__auto___55635 + (1));
i__43069__auto___55635 = G__55636;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args55628.length)].join('')));
...
var vec__55631 = result;
var munged_ns = cljs.core.nth.call(null,vec__55631,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__55631,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__55631,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__55631,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__55631,(4),null);
var arity = cljs.core.nth.call(null,vec__55631,(5),null);
...
if(cljs.core.truth_(temp__4655__auto__)){
var vec__55644 = temp__4655__auto__;
var munged_name = cljs.core.nth.call(null,vec__55644,(0),null);
var args = cljs.core.nth.call(null,vec__55644,(1),null);
var vec__55647 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__55647,(0),null);
var name = cljs.core.nth.call(null,vec__55647,(1),null);
...
var G__55650 = (arity + (1));
var G__55651 = (function (){var temp__4655__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__4655__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__55652){
var vec__55656 = p__55652;
var arity = cljs.core.nth.call(null,vec__55656,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__55656,(1),null);
...
var fixed_arities = devtools.munging.collect_fn_fixed_arities.call(null,f,(function (){var or__41993__auto__ = max_fixed_arity;
if(cljs.core.truth_(or__41993__auto__)){
return or__41993__auto__;
} else {
...
return cljs.core.get.call(null,arities,p1__55659_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return (function (p1__55660_SHARP_){
return cljs.core.drop.call(null,(2),p1__55660_SHARP_);
...
var args__43075__auto__ = [];
var len__43068__auto___55667 = arguments.length;
var i__43069__auto___55668 = (0);
while(true){
if((i__43069__auto___55668 < len__43068__auto___55667)){
args__43075__auto__.push((arguments[i__43069__auto___55668]));

var G__55669 = (i__43069__auto___55668 + (1));
i__43069__auto___55668 = G__55669;
continue;
} else {
}
break;
...
var argseq__43076__auto__ = ((((1) < args__43075__auto__.length))?(new cljs.core.IndexedSeq(args__43075__auto__.slice((1)),(0),null)):null);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__43076__auto__);
});

devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__55663){
var vec__55664 = p__55663;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__55664,(0),null);
...
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq55661){
var G__55662 = cljs.core.first.call(null,seq55661);
var seq55661__$1 = cljs.core.next.call(null,seq55661);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic(G__55662,seq55661__$1);
});
...
var G__55671 = (((arg instanceof cljs.core.Keyword))?arg.fqn:null);
switch (G__55671) {
...
return devtools.munging.args_lists_to_strings.call(null,devtools.munging.arities_to_args_lists.call(null,(function (){var or__41993__auto__ = devtools.munging.collect_fn_arities.call(null,f);
if(cljs.core.truth_(or__41993__auto__)){
return or__41993__auto__;
} else {
...
return [cljs.core.str((cljs.core.truth_((function (){var and__41981__auto__ = include_ns_QMARK_;
...
return [cljs.core.str((cljs.core.truth_(include_protocol_ns_QMARK_)?protocol_ns:null)),cljs.core.str(((!(cljs.core.empty_QMARK_.call(null,protocol_name)))?[cljs.core.str((cljs.core.truth_(include_protocol_ns_QMARK_)?".":null)),cljs.core.str(protocol_name)].join(''):null)),cljs.core.str(((!(cljs.core.empty_QMARK_.call(null,protocol_method)))?[cljs.core.str((cljs.core.truth_((function (){var or__41993__auto__ = include_protocol_ns_QMARK_;
if(cljs.core.truth_(or__41993__auto__)){
return or__41993__auto__;
} else {
...
var map__55678 = options;
var map__55678__$1 = ((((!((map__55678 == null)))?((((map__55678.cljs$lang$protocol_mask$partition0$ & (64))) || (map__55678.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__55678):map__55678);
var include_ns_QMARK_ = cljs.core.get.call(null,map__55678__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__55678__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__55678__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__55678__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__55679 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__55679,(0),null);
var fn_name = cljs.core.nth.call(null,vec__55679,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__55679,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__55679,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__55679,(4),null);
var arity = cljs.core.nth.call(null,vec__55679,(5),null);
...
var protocol_part = (cljs.core.truth_((function (){var and__41981__auto__ = protocol_ns;
if(cljs.core.truth_(and__41981__auto__)){
return cljs.core.not.call(null,(function (){var and__41981__auto____$1 = silence_common_protocols_QMARK_;
...
return [cljs.core.str((function (){var or__41993__auto__ = protocol_part;
if(cljs.core.truth_(or__41993__auto__)){
return or__41993__auto__;
} else {
return fn_part;
...
var o__54634__auto__ = f;
return goog.object.get(o__54634__auto__,"getBasis").call(o__54634__auto__);
});
/**
...
if(cljs.core.truth_((function (){var and__41981__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__41981__auto__)){
...
}catch (e55684){var e__54659__auto__ = e55684;
...
var G__55685 = goog.object.get(obj,cljs.core.first.call(null,path));
var G__55686 = cljs.core.rest.call(null,path);
obj = G__55685;
path = G__55686;
continue;
} else {
...
var partition_bits = (function (){var or__41993__auto__ = goog.object.get(obj,partition_key);
if(cljs.core.truth_(or__41993__auto__)){
return or__41993__auto__;
} else {
return (0);
...
return (function (accum,p__55691){
var vec__55692 = p__55691;
var bit = cljs.core.nth.call(null,vec__55692,(0),null);
var protocol = cljs.core.nth.call(null,vec__55692,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__55695){
var vec__55699 = p__55695;
var ns = cljs.core.nth.call(null,vec__55699,(0),null);
var name = cljs.core.nth.call(null,vec__55699,(1),null);
var selector = cljs.core.nth.call(null,vec__55699,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__55708,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__55708,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__55708,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__55702_SHARP_){
return goog.object.get(obj,cljs.core.first.call(null,p1__55702_SHARP_));
});})(name,sorted_matches,vec__55708,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1504122785829