...
var args56233 = [];
var len__43068__auto___56239 = arguments.length;
var i__43069__auto___56240 = (0);
while(true){
if((i__43069__auto___56240 < len__43068__auto___56239)){
args56233.push((arguments[i__43069__auto___56240]));

var G__56241 = (i__43069__auto___56240 + (1));
i__43069__auto___56240 = G__56241;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args56233.length)].join('')));
...
if(typeof devtools.toolbox.t_devtools$toolbox56236 !== 'undefined'){
} else {
...
*/
devtools.toolbox.t_devtools$toolbox56236 = (function (obj,header,style,tag,meta56237){
this.obj = obj;
this.header = header;
this.style = style;
this.tag = tag;
...
devtools.toolbox.t_devtools$toolbox56236.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_56238,meta56237__$1){
var self__ = this;
var _56238__$1 = this;
return (new devtools.toolbox.t_devtools$toolbox56236(self__.obj,self__.header,self__.style,self__.tag,meta56237__$1));
});

devtools.toolbox.t_devtools$toolbox56236.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_56238){
var self__ = this;
var _56238__$1 = this;
return self__.meta56237;
});

devtools.toolbox.t_devtools$toolbox56236.prototype.devtools$protocols$IFormat$ = true;

devtools.toolbox.t_devtools$toolbox56236.prototype.devtools$protocols$IFormat$_header$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
...
devtools.toolbox.t_devtools$toolbox56236.prototype.devtools$protocols$IFormat$_has_body$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
return true;
});

devtools.toolbox.t_devtools$toolbox56236.prototype.devtools$protocols$IFormat$_body$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
...
devtools.toolbox.t_devtools$toolbox56236.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"obj","obj",-1672671807,null),new cljs.core.Symbol(null,"header","header",1759972661,null),new cljs.core.Symbol(null,"style","style",1143888791,null),new cljs.core.Symbol(null,"tag","tag",350170304,null),new cljs.core.Symbol(null,"meta56237","meta56237",-1465426409,null)], null);
});

devtools.toolbox.t_devtools$toolbox56236.cljs$lang$type = true;

devtools.toolbox.t_devtools$toolbox56236.cljs$lang$ctorStr = "devtools.toolbox/t_devtools$toolbox56236";

devtools.toolbox.t_devtools$toolbox56236.cljs$lang$ctorPrWriter = (function (this__42599__auto__,writer__42600__auto__,opt__42601__auto__){
return cljs.core._write.call(null,writer__42600__auto__,"devtools.toolbox/t_devtools$toolbox56236");
});

devtools.toolbox.__GT_t_devtools$toolbox56236 = (function devtools$toolbox$__GT_t_devtools$toolbox56236(obj__$1,header__$1,style__$1,tag__$1,meta56237){
return (new devtools.toolbox.t_devtools$toolbox56236(obj__$1,header__$1,style__$1,tag__$1,meta56237));
});

}

return (new devtools.toolbox.t_devtools$toolbox56236(obj,header,style,tag,cljs.core.PersistentArrayMap.EMPTY));
});
...
//# sourceMappingURL=toolbox.js.map?rel=1504724093376